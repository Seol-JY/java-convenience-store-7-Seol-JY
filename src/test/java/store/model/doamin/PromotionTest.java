...
class PromotionTest {
    ...
    class 날짜_범위_검증_테스트 {
        ...
        void 종료일이_시작일보다_이전이면_예외를_발생시킨다() {
            // given
            PromotionFileDto dto = createPromotionDtoWithInvalidDateRange();
        ...
        void 시작일이_null이면_예외를_발생시킨다() {
            // given
            PromotionFileDto dto = createPromotionDtoWithNullStartDate();
        ...
        void 종료일이_null이면_예외를_발생시킨다() {
            // given
            PromotionFileDto dto = createPromotionDtoWithNullEndDate();
    ...
    private PromotionFileDto createPromotionDtoWithInvalidDateRange() {
        return new PromotionFileDto(
                "테스트 프로모션",
                2,
                1,
                LocalDate.of(2024, 12, 31),  // 종료일보다 늦은 시작일
                LocalDate.of(2024, 1, 1)
        );
    }

    private PromotionFileDto createPromotionDtoWithNullStartDate() {
        return new PromotionFileDto(
                "테스트 프로모션",
                2,
                1,
    ...
    private PromotionFileDto createPromotionDtoWithNullEndDate() {
        return new PromotionFileDto(
                "테스트 프로모션",
                2,
                1,
