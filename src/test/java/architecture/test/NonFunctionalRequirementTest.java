...
public class NonFunctionalRequirementTest {
    private static final String BASE_PATH = "./src/main/java/store";
    ...
    @Test
    void 메서드는_10_줄을_초과하지_않아야_한다() throws IOException {
        CodeStyle.analyze()
                .checkRule(StyleRules.methodSize(10))
                .check(BASE_PATH)
                .assertNoViolations();
    }
    ...
    @Test
    void 메서드_파라미터는_모두_final이어야_한다() throws IOException {
        CodeStyle.analyze()
                .checkRule(
